...
#
# **************************************************************************
# Source: https://practice.geeksforgeeks.org/problems/maximum-subset-xor/1 (GeeksForGeeks - Maximum subset XOR)
# **************************************************************************
#
# **************************************************************************
...
class Solution(object):
    ...
    # maximum XOR subset
    # in set[]
    def maxSubarrayXOR(self, set: List[int]) -> int:
        n = len(set)
        # Initialize index of
        # chosen elements
        index = 0
...
class Test(unittest.TestCase):
    ...
    def test_maxSubarrayXOR(self) -> None:
        sol = Solution()
        for set, solution in ([[2, 4, 5], 7], [[9, 8, 5], 13]):
            self.assertEqual(solution, sol.maxSubarrayXOR(set))
